/* =========================================================
   Pharmacy Nexus — Pharmacy Duel Arcade
   Single-file game module based on the uploaded arcade concept.
   Upload to: assets/js/pn-pharmacy-duel-arcade.js
   Add before </body>:
   <script src="./assets/js/pn-pharmacy-duel-arcade.js"></script>
   ========================================================= */
...
(function () {
  ...
  const CONFIG = {
    ...
    storageKey: "pn_pharmacy_duel_arcade_history_v1"
  };
  ...
  const BOT_WRONG_INDICES = [5, 8, 9];
  const BOT_TIME_PER_QUESTION = [2.1, 1.8, 2.5, 1.5, 2.0, 1.9, 2.3, 1.7, 2.2, 1.6];
      ...
      <div class="pn-duel-launch-grid">
        ...
        <div class="pn-duel-vs-preview" aria-hidden="true">
          ...
          <div class="pn-duel-player-card">
            ...
            <div style="color:#ff6b9d;font-size:.85rem;">Target: 7/10</div>
          </div>
        </div>
      </div>
    `;
        ...
        <div class="pn-duel-body">
          <div class="pn-duel-screen active" id="pn-duel-start-screen">
            <div class="pn-duel-start">
              ...
              <p class="pn-duel-subtitle">Answer 10 questions. Beat Nexus Bot's 7/10 target.</p>
  ...
  function loadQuestion() {
    ...
    q.options.forEach((opt, index) => {
      ...
      btn.innerHTML = `<span class="pn-duel-letter">${letters[index]}</span><span>${escapeHtml(opt)}</span>`;
  ...
  function showResults() {
    ...
    state.botScore = CONFIG.botFinalScore;
    ...
    if (state.playerScore > state.botScore) {
      ...
      resultMessage.innerHTML = "🎉 Incredible. You outsmarted the bot. Your pharmacy knowledge is looking sharp.";
      startConfetti();
      ...
      resultMessage.innerHTML = "⚖️ Great match. One more correct answer next time and you win.";
      startConfetti();
    } else {
      botCard.classList.add("winner");
      botBadge.classList.add("show");
      resultTitle.innerHTML = `<span class="pn-duel-lose">NEXUS BOT WINS</span>`;
      resultMessage.innerHTML = "🤖 The bot got the better of you this time. Study up and try again.";
    }
